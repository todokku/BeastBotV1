...
*DISCLAIMER* This is not going against any Youtube Guidelines, please do not replicate unless you know what you're doing. 



## Basic rough thoughts and research,
...
## Precautions
1) Youtube Data API V3 has quota limitations, therefore loop should ideally start running from 3:55PM ET, hopefully MrBeast is on time. Quota is 10,000 requests per day. ( 10,000 requests / 60 seconds ) = 166.666666667 minutes. That would be more than two hours of pinging which is great. 
